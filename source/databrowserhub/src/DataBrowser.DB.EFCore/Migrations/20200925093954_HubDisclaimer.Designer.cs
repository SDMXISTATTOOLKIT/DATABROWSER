...
namespace DataBrowser.DB.EFCore.Migrations
{
    ...
    [Migration("20200925093954_HubDisclaimer")]
    partial class HubDisclaimer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataBrowser.Domain.Entities.DBoard.Dashboard", b =>
                {
                    ...
                    b.Property<string>("FilterLevels")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DataBrowser.Domain.Entities.ViewTemplates.ViewTemplate", b =>
                {
                    b.Property<int>("ViewTemplateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DataBrowser.Domain.Entities.DBoard.Dashboard", b =>
                {
                    b.HasOne("DataBrowser.Domain.Entities.TransatableItems.TransatableItem", "Title")
                        .WithOne()
                        .HasForeignKey("DataBrowser.Domain.Entities.DBoard.Dashboard", "TitleFK")
            ...
            modelBuilder.Entity("DataBrowser.Domain.Entities.DBoard.DashboardNode", b =>
                {
                    b.HasOne("DataBrowser.Domain.Entities.DBoard.Dashboard", "Dashboard")
                        .WithMany("Nodes")
            ...
            modelBuilder.Entity("DataBrowser.Domain.Entities.Hubs.Hub", b =>
                {
                    ...
                    b.HasOne("DataBrowser.Domain.Entities.TransatableItems.TransatableItem", "Disclaimer")
                        .WithOne()
                        .HasForeignKey("DataBrowser.Domain.Entities.Hubs.Hub", "DisclaimerFk")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("DataBrowser.Domain.Entities.ViewTemplates.ViewTemplate", b =>
                {
                    b.HasOne("DataBrowser.Domain.Entities.TransatableItems.TransatableItem", "DecimalSeparator")
                        .WithOne()
                        .HasForeignKey("DataBrowser.Domain.Entities.ViewTemplates.ViewTemplate", "DecimalSeparatorFk")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("DataBrowser.Domain.Entities.TransatableItems.TransatableItem", "Title")
                        .WithOne()
                        .HasForeignKey("DataBrowser.Domain.Entities.ViewTemplates.ViewTemplate", "TitleFK")
                        .OnDelete(DeleteBehavior.SetNull);
                });

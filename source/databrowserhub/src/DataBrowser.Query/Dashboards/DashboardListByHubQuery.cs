...
{
    public class DashboardListByHubQuery : DashboardQueryBase, IQuery<List<DashboardViewModel>>
    {
        public DashboardListByHubQuery(int hubId,
        ...
        public class DashboardListByHubHandler : IRequestHandler<DashboardListByHubQuery, List<DashboardViewModel>>
        {
            ...
            public async Task<List<DashboardViewModel>> Handle(DashboardListByHubQuery request,
                CancellationToken cancellationToken)
            {
                ...
                var dashboardList =
                    await _dashboardRepository.FindAsync(new DashboardByHubIdSpecification(request.HubId));
